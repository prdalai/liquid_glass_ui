          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: NetworkImage('https://images.unsplash.com/photo-1510931566802-990a2a5370d0?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
                fit: BoxFit.cover,
              ),
            ),
          ),
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: const [
                        Icon(Icons.keyboard_arrow_down_rounded, color: Colors.white, size: 28),
                        SizedBox(width: 8),
                        Text(
                          'NOW PLAYING',
                ...
                LiquidGlassContainer(
                  ...
                  child: Column(
                    children: [
                      ClipRRect(
                        borderRadius: BorderRadius.circular(15), // Slightly rounded corners for album art
                        child: Image.network(
                          ...
                          height: MediaQuery.of(context).size.width * 0.6, // Responsive size
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: const [
                          ...
                          Text('3:25', style: TextStyle(color: Colors.white70)), // Total song duration
                        ],
                      ),
                    ),
                    const SizedBox(height: 20),
                    Row(
                      ...
                      children: [
                        ...
                        LiquidGlassContainer(
                          blur: 25,
                          opacity: 0.4,
                          borderRadius: BorderRadius.circular(50), // Circular play button
                ...
                LiquidGlassContainer(
                  ...
                  child: Row(
                    ...
                    children: const [
                      ...
                      Icon(Icons.library_music, color: Colors.white70, size: 30),
